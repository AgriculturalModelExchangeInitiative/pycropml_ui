library(gsubfn)
library (gsubfn) 
setwd('C:/Users/midingoy/Documents/Simplace_SoilTemperature/src/r')
...
model_soiltemperature <- function (cCarbonContent,
    ...
    return (list ("SoilSurfaceTemperature" = SoilSurfaceTemperature,"SnowIsolationIndex" = SnowIsolationIndex,"SnowWaterContent" = SnowWaterContent,"SoilTempArray" = SoilTempArray))
}