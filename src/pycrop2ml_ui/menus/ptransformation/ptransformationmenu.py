...
class ptransformationMenu():
    ...
    def __init__(self, local):
        ...
        self._java = wg.Checkbox(value=False, description='Java', disabled=True)
        self._csharp = wg.Checkbox(value=False, description='CSharp', disabled=True)
        self._fortran = wg.Checkbox(value=False, description='Fortran', disabled=True)
        self._python = wg.Checkbox(value=False, description='Python', disabled=True)
        ...
        self._record = wg.Checkbox(value=False, description='Record', disabled=True)
    ...
    def _eventApply(self, b):
        ...
        if not self._path.value:
            ...
            if self._sirius.value:
                self._listlanguage.append('sirius')
            ...
            if not self._listlanguage:
                ...
                for lg in self._listlanguage:
                    try:
                        transpile_component(self._path.value,self._path.value, lg)
                    except:
